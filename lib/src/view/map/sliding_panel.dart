...
class _SlidingUpPanelState extends State<SlidingUpPanel>
  ...
  void initState() {
    ...
    _ac = new AnimationController(
        ...
        value: widget.defaultPanelState == PanelState.OPEN
            ? 1.0
            : 0.0 //set the default panel state (i.e. set initial value of _ac)
        )
      ..addListener(() {
        setState(() {});
    ...
    if(widget.defaultPanelState == PanelState.HIDDEN){
      setState(() {
